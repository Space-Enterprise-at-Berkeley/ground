    ...
    return (
      <AppBar position="static" color="default" elevation={0} className={classes.bar}>
        <Toolbar variant="dense">
          ...
          <Button className={EReg1Connected ? classes.connectedButton : classes.disconnectedButton}>EReg 1 - {EReg1kbps} kbps</Button>
          <Button className={EReg2Connected ? classes.connectedButton : classes.disconnectedButton}>EReg 2 - {EReg2kbps} kbps</Button>
          <Button className={EReg3Connected ? classes.connectedButton : classes.disconnectedButton}>EReg 3 - {EReg3kbps} kbps</Button>
          <Button className={EReg4Connected ? classes.connectedButton : classes.disconnectedButton}>EReg 4 - {EReg4kbps} kbps</Button>
